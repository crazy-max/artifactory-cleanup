...
1. [Fork](https://github.com/crazy-max/artifactory-cleanup/fork) and clone the repository
...
8. Push to your fork and [submit a pull request](https://github.com/crazy-max/artifactory-cleanup/compare)
